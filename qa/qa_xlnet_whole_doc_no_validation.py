...
with open('../data/question_answering_gold_standard_fine_grained_textrank_70/q{}_train.json'.format(sys.argv[1])) as train_file:
    train_set = json.load(train_file)

with open('../data/question_answering_gold_standard_fine_grained_textrank_70/q{}_dev.json'.format(sys.argv[1])) as dev_file:
    dev_set = json.load(dev_file)

with open('../data/question_answering_gold_standard_fine_grained_textrank_70/q{}_test.json'.format(sys.argv[1])) as test_file:
