...
with open('../data/question_answering/q1_train.json') as train_file:
    train_set = json.load(train_file)

with open('../data/question_answering/q1_dev.json') as dev_file:
    dev_set = json.load(dev_file)

with open('../data/question_answering/q1_test.json') as test_file:
